...
const path = {
  ...
  src: {
    ...
    scss: `${DEVELOPMENT_FOLDER}/sass/index.sass`,
  ...
  watch: {
    ...
    scss: `${DEVELOPMENT_FOLDER}/sass/**/*.{sass,css}`,
    js: `${DEVELOPMENT_FOLDER}/js/**/*.js`,
  },
  fonts: {
    dir: `${DEVELOPMENT_FOLDER}/assets/fonts`,
    styles: `${DEVELOPMENT_FOLDER}/sass/config/fonts.sass`,
  },
};
...
exports.default = series(
  series(
    removeBuildDir,
    parallel(compileMarkup, compileStyles, compileScripts, copyAssets, buildImages)
  ),
